/**
 * Resolution cases answered correctly, per browser.
 *
...
const KEY = "maxdoubin-resolve-solved";

export const loadSolvedResolves = (): string[] => {
  try {
...
export function recordSolvedResolves(id: string): void {
  const list = loadSolvedResolves();
