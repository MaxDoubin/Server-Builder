...
const KEY = "maxdoubin-malloctrim-solved";

export const loadSolvedMalloctrim = (): string[] => {
  try {
...
export function recordSolvedMalloctrim(slug: string): void {
  const list = loadSolvedMalloctrim();
