...
const KEY = "maxdoubin-timewait-solved";

export const loadSolvedTimewait = (): string[] => {
  try {
...
export function recordSolvedTimewait(slug: string): void {
  const list = loadSolvedTimewait();
