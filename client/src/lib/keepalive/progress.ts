...
const KEY = "maxdoubin-keepalive-progress";

export const loadSolvedKeepalive = (): string[] => {
  try {
...
export function recordSolvedKeepalive(slug: string): void {
  const list = loadSolvedKeepalive();
