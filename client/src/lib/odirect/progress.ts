...
const KEY = "maxdoubin-odirect-solved";

export const loadSolvedOdirect = (): string[] => {
  try {
...
export function recordSolvedOdirect(slug: string): void {
  const list = loadSolvedOdirect();
