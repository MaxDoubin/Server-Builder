...
const KEY = "maxdoubin-conntrack-solved";

export const loadSolvedConntrack = (): string[] => {
  try {
...
export function recordSolvedConntrack(slug: string): void {
  const list = loadSolvedConntrack();
