...
const KEY = "maxdoubin-writeback-solved";

export const loadSolvedWriteback = (): string[] => {
  try {
...
export function recordSolvedWriteback(slug: string): void {
  const list = loadSolvedWriteback();
