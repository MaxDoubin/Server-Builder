...
export const PRACTICE_SURFACES: PracticeSurface[] = [
  ...
  { href: "/backlog", eyebrow: "Trace", title: "The server is idle and the connections are timing out", group: "diagnose" , reading: ["the-connection-opened-and-then-nothing-happened", "queueing-theory-for-operators", "nginx-reverse-proxy-setup"] },
