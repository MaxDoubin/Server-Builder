...
const KEY = "maxdoubin-pipebuf-solved";

export const loadSolvedPipebuf = (): string[] => {
  try {
...
export function recordSolvedPipebuf(slug: string): void {
  const list = loadSolvedPipebuf();
