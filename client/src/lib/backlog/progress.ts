...
const KEY = "maxdoubin-backlog-progress";

export const loadSolvedBacklog = (): string[] => {
  try {
...
export function recordSolvedBacklog(slug: string): void {
  const list = loadSolvedBacklog();
