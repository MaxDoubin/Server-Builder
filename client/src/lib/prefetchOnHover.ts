...
const EXACT_ROUTES: Record<string, RouteChunk> = {
  ...
  "/practice": { load: () => import("@/pages/cinematic/CinematicPractice") },
  ...
  "/space": { load: () => import("@/pages/cinematic/CinematicSpace") },
  "/oom": { load: () => import("@/pages/cinematic/CinematicOom") },
  "/units": { load: () => import("@/pages/cinematic/CinematicUnits") },
  "/nat": { load: () => import("@/pages/cinematic/CinematicNat") },
  "/alerts": { load: () => import("@/pages/cinematic/CinematicAlerts") },
  "/load": { load: () => import("@/pages/cinematic/CinematicLoad") },
  ...
  "/keepalive": { load: () => import("@/pages/cinematic/CinematicKeepalive") },
  "/startlimit": { load: () => import("@/pages/cinematic/CinematicStartlimit") },
  "/neigh": { load: () => import("@/pages/cinematic/CinematicNeigh") },
  "/shm": { load: () => import("@/pages/cinematic/CinematicShm") },
  "/maxstartups": { load: () => import("@/pages/cinematic/CinematicMaxstartups") },
  "/retrans": { load: () => import("@/pages/cinematic/CinematicRetrans") },
  "/rcvbuf": { load: () => import("@/pages/cinematic/CinematicRcvbuf") },
  "/timewait": { load: () => import("@/pages/cinematic/CinematicTimewait") },
  "/overcommit": { load: () => import("@/pages/cinematic/CinematicOvercommit") },
  ...
  "/exit": { load: () => import("@/pages/cinematic/CinematicExit") },
  ...
  "/resolve": { load: () => import("@/pages/cinematic/CinematicResolve") },
  "/firewall": { load: () => import("@/pages/cinematic/CinematicFirewalls") },
  "/triage": { load: () => import("@/pages/cinematic/CinematicTriage") },
  "/challenges": { load: () => import("@/pages/cinematic/CinematicChallenges") },
...
const PREFIX_ROUTES: Record<string, RouteChunk> = {
  ...
  "/capture/": { load: () => import("@/pages/cinematic/CinematicCapture") },
  "/allocate/": { load: () => import("@/pages/cinematic/CinematicAllocate") },
  "/firewall/": { load: () => import("@/pages/cinematic/CinematicFirewall") },
  "/challenges/": { load: () => import("@/pages/cinematic/CinematicChallenge") },
