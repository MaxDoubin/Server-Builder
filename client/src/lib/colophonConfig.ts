...
export const DECISIONS = [
  {
    id: "one-article",
    title: "A reader downloads one article, not two hundred and fifty",
    body: [
      "The archive is 250 posts. They used to live in one TypeScript module, which meant opening a single article pulled in roughly 1.1MB of the other 249 before a word appeared on screen.",
  ...
  },
  {
    ...
    body: [
      ...
      "The prerenderer also writes the onward links a crawler needs. The React page renders previous, next, and related posts, but a non-executing crawler used to see only a link back to the index, which made all 250 posts dead ends on the first pass. Those links are now in the static HTML too.",
    ],
  },
  {
    id: "css-transition",
