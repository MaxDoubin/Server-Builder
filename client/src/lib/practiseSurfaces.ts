...
export const PRACTISE_SURFACES: PractiseSurface[] = [
  ...
  { href: "/ports", eyebrow: "Predict", title: "Out of ports", group: "diagnose" , reading: ["tcp-congestion-control-basics", "linux-network-tuning-without-cargo-cult", "load-balancing-l4-vs-l7"] },
