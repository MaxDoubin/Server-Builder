...
export const PRACTISE_SURFACES: PractiseSurface[] = [
  ...
  { href: "/load", eyebrow: "Predict", title: "Forty, and idle", group: "diagnose" , reading: ["linux-disk-io-troubleshooting", "linux-page-cache-and-io", "prometheus-server-monitoring"] },
