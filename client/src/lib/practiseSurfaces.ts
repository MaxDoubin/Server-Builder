...
export const PRACTISE_SURFACES: PractiseSurface[] = [
  ...
  { href: "/alerts", eyebrow: "Predict", title: "The graph crossed the line", group: "diagnose" , reading: ["prometheus-server-monitoring", "network-monitoring-system-build", "log-analysis-methodology"] },
