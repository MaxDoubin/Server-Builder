...
export const PRACTISE_SURFACES: PractiseSurface[] = [
  ...
  { href: "/oom", eyebrow: "Predict", title: "Something has to die", group: "diagnose" , reading: ["oom-killer-and-swap-sizing", "cgroups-v2-resource-limits", "linux-page-cache-and-io"] },
