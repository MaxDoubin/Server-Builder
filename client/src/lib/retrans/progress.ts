...
const KEY = "maxdoubin-retrans-solved";

export const loadSolvedRetrans = (): string[] => {
  try {
...
export function recordSolvedRetrans(slug: string): void {
  const list = loadSolvedRetrans();
