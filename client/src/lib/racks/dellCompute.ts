...
export const dellComputeRack: RackDefinition = {
  ...
  devices: [
    ...
    },
    {
      ...
      role: "An open rack unit is not neutral. Hot exhaust from behind the rack turns straight through the gap and into the intake of whatever sits above it, and the server reads its own waste heat as room air. Solid is the point: a vented panel is a different product for a different problem.",
      family: "blank",
      look: "solid",
      watts: null,
      accent: ACCENT.passive,
    },
    {
      ...
      role: "Panels are sold in one, two, three and four rack units, so an odd gap gets closed by combining them rather than by leaving the remainder open. Below it is the power, and the power is at the bottom because a UPS with its battery tray is the heaviest thing in the rack.",
      family: "blank",
      look: "solid",
      watts: null,
      accent: ACCENT.passive,
