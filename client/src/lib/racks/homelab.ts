...
export const homelabRack: RackDefinition = {
  ...
  devices: [
    ...
    },
    {
      ...
      role: "Airflow discipline, and the next rack unit to be spent. Every homelab rack has exactly one of these standing between it and the next impulse purchase.",
      family: "blank",
      look: "vented",
      watts: null,
      accent: ACCENT.passive,
