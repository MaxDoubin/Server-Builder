...
export const storageDenseRack: RackDefinition = {
  ...
  devices: [
    ...
    },
    {
      ...
      family: "storage",
      finish: "dark",
      bays: { count: 84, occupied: 84, label: "3.5 inch bays in two top load drawers" },
      watts: null,
      accent: ACCENT.shelf,
    ...
    },
    {
      ...
      family: "storage",
      finish: "dark",
      bays: { count: 84, occupied: 66, label: "3.5 inch bays in two top load drawers" },
      watts: null,
      accent: ACCENT.shelf,
      url: "https://www.dell.com/support/manuals/en-us/powervault-me4084/me4_series_om_pub/5u84-enclosure-chassis",
    },
    {
      ...
      family: "storage",
      finish: "dark",
      bays: { count: 60, occupied: 42, label: "3.5 inch bays in three top load drawers" },
      watts: null,
      accent: ACCENT.shelf,
    },
    {
      ...
      family: "storage",
      finish: "dark",
      bays: { count: 24, occupied: 24, label: "2.5 inch flash bays" },
      watts: null,
      accent: ACCENT.head,
    },
    {
