...
const KEY = "maxdoubin-startlimit-solved";

export const loadSolvedStartlimit = (): string[] => {
  try {
...
export function recordSolvedStartlimit(slug: string): void {
  const list = loadSolvedStartlimit();
