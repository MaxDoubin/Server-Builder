...
const KEY = "maxdoubin-reuseport-solved";

export const loadSolvedReuseport = (): string[] => {
  try {
...
export function recordSolvedReuseport(slug: string): void {
  const list = loadSolvedReuseport();
