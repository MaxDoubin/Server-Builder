...
const KEY = "maxdoubin-inotify-solved";

export const loadSolvedInotify = (): string[] => {
  try {
...
export function recordSolvedInotify(slug: string): void {
  const list = loadSolvedInotify();
