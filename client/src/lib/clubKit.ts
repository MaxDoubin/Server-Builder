...
export const KIT_SESSIONS: KitSession[] = [
  ...
  },
  {
    ...
    evidence: "Collect the written notes and actually read them. They should name specific categories and techniques, not say practice more. Those notes are your syllabus for next season; if they are vague, the debrief was too gentle and next time you name the time sinks yourself.",
...
export const KIT_RESOURCES: KitResource[] = [
  {
    ...
    what: "Carnegie Mellon's permanent beginner CTF, with a browser shell so nothing needs installing. This is where week one happens, and the picoGym holds hundreds of retired challenges for practice all year.",
    cost: "free",
  },
  {
    name: "OverTheWire Bandit",
    url: "https://overthewire.org/wargames/bandit/",
    what: "A thirty-level SSH wargame that teaches the command line by making it the only option. Good homework between weeks two and three, and a real stretch for a member who is ahead.",
    cost: "free",
  },
  {
    name: "CyberChef",
    url: "https://gchq.github.io/CyberChef/",
    what: "Browser-based encoding, decoding, and analysis, built by GCHQ. Runs entirely client side, so it works on locked-down school machines. The tool for weeks four and six.",
    cost: "free",
  },
  {
    name: "dCode",
    url: "https://www.dcode.fr/en",
    what: "A large library of browser cipher tools and an identifier that guesses a scheme from a sample. Useful for week four when a Caesar or Vigenere needs checking against the paper work.",
    cost: "free",
  },
  {
    name: "Wireshark",
    url: "https://www.wireshark.org/",
    what: "The standard packet analyser, free and open source. This is the tool week five is built around; install it ahead of the meeting.",
    cost: "free",
  },
  {
    name: "Wireshark sample captures",
    url: "https://wiki.wireshark.org/SampleCaptures",
    what: "Published packet captures, so a club never has to capture its own school network to have something to read. Grab http.cap and a DNS capture for week five.",
    cost: "free",
  },
  {
    name: "Malware-Traffic-Analysis.net",
    url: "https://www.malware-traffic-analysis.net/",
    what: "Real packet captures with guided exercises and answers, from a working analyst. A step up from the Wireshark samples for weeks five and eight, and strong homework for a member who is ahead.",
    cost: "free",
  },
  {
    name: "John the Ripper",
    url: "https://www.openwall.com/john/",
    what: "The classic password hash cracker. Free and open source, and the tool that makes the week six demonstration land.",
    cost: "free",
  },
  {
    name: "hashcat",
    url: "https://hashcat.net/hashcat/",
    what: "The other standard cracker, faster where a machine has a GPU. Useful in week six to show a wordlist attack chewing through the fast hashes and stalling on bcrypt.",
    cost: "free",
  },
  {
    name: "CrackStation",
    url: "https://crackstation.net/",
    what: "A browser hash lookup that instantly reverses unsalted MD5 and SHA-1 of common words, and publishes the wordlists behind it. A fast way to make the week six point without installing anything.",
    cost: "free",
  },
  {
    name: "OWASP Juice Shop",
    url: "https://owasp.org/www-project-juice-shop/",
    what: "A deliberately broken web application, built for teaching. The safe target for week seven, with a hosted demo if Docker is not allowed on your network.",
    cost: "free",
  },
  {
    name: "OWASP Top Ten",
    url: "https://owasp.org/www-project-top-ten/",
    what: "The reference list of the most common web application risks. The vocabulary to name the week seven bugs and the fixes, and what a defender is actually guarding against.",
    cost: "free",
  },
  {
    name: "Hacksplaining",
    url: "https://www.hacksplaining.com/",
    what: "Short interactive lessons that walk through a web vulnerability and its fix in the browser. Good preparation before week seven for a member with no background.",
    cost: "free",
  },
  {
    name: "Google Gruyere",
    url: "https://google-gruyere.appspot.com/",
    what: "Google's browser-based web security codelab, where each member gets their own broken instance. A no-install alternative target for week seven when the shared Juice Shop is not enough to go around.",
    cost: "free",
  },
  {
    name: "ExifTool",
    url: "https://exiftool.org/",
    what: "Reads and writes the metadata buried in photos and documents, including the GPS coordinates a camera leaves behind. The week nine forensics tool, and the concrete link back to week three.",
    cost: "free",
  },
  {
    name: "MITRE ATT&CK",
  ...
  },
  {
    ...
    what: "Blue team challenges built from real captures and logs, the defensive mirror of a CTF. The free tier covers weeks five and eight and keeps an advanced member busy between meetings.",
    cost: "free tier",
  },
  {
    name: "TryHackMe",
  ...
  },
  {
    ...
    what: "A calendar of capture the flag competitions worldwide, with a team page to track results. Where a club looks once the National Cyber League is not the only event on its year.",
    cost: "free",
  },
  {
...
export const KIT_FAILURES: KitFailure[] = [
  ...
  {
    symptom: "A meeting comes and two people show up, or nobody does.",
    cause: "Attendance in a new club is habit, not loyalty, and the habit is not built yet. One quiet week is normal; a run of them usually means the time, the room, or the reminder failed, not the club.",
    fix: "Run the meeting anyway for whoever came, even if that is one person, and make it worth their time, because word that the club runs as promised travels. Fix the mechanics before the content: pick one fixed day and room and never move them, send a reminder the morning of every meeting through whatever channel students actually read, and get the club into the daily announcements. If one specific week is dead, check the calendar for a test, a game, or a break before you conclude anything about the club.",
  },
  {
  ...
  {
    symptom: "One member is miles ahead and is either bored or is quietly running the whole room.",
    cause: "A mixed room is normal in this field and it is an asset, but only if the strongest member has a job. Left with nothing to stretch them, they either check out or solve everything out loud and teach everyone else to stop trying.",
    fix: "Give them a role, not just harder problems. The best one is teaching: pair them with someone stuck and make the task explaining it, because a member who can teach a category understands it better than one who can only solve it. When you do want to stretch them, point them past this plan at OverTheWire, the harder picoGym sets, Malware-Traffic-Analysis.net, or CyberDefenders, and have them report back on what they found. Above all, do not let them call out answers; a flag announced to the room ends four other people's puzzle.",
  },
  {
...
export const KIT_RULES: string[] = [
  "We only touch systems we own, systems the club stood up for practice, or systems published by their owners for people to practice on. Nothing else, ever, including systems that look abandoned.",
  ...
  "Findings stay inside the exercise. We do not pass around a working exploit, a cracked password, or anyone's recovered private data, and we do not post a real finding or a screenshot of one online, including to show what we can do.",
  "Permission is specific, written, and current. A system being reachable, looking abandoned, or having a public bug bounty page is not the same as us being allowed to touch it. If we are not sure we are allowed, the answer is no until the advisor confirms otherwise.",
  "These skills are for protecting people. Anyone who uses them to harm, harass, surveil, or gain an advantage over another person is out of the club, and we say that on the first day rather than after something happens.",
];
