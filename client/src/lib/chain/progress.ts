/**
 * Certificate chain cases answered correctly, per browser.
 *
...
const KEY = "maxdoubin-chain-solved";

export const loadSolvedChains = (): string[] => {
  try {
...
export function recordSolvedChains(id: string): void {
  const list = loadSolvedChains();
