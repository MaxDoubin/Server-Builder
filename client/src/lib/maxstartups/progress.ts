...
const KEY = "maxdoubin-maxstartups-solved";

export const loadSolvedMaxstartups = (): string[] => {
  try {
...
export function recordSolvedMaxstartups(slug: string): void {
  const list = loadSolvedMaxstartups();
