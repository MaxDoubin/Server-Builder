...
const CinematicHandshake = lazyWithRetry(() =>
...
const CinematicAlerts = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicAlerts").then((m) => ({ default: m.CinematicAlerts })),
);
const CinematicLoad = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicLoad").then((m) => ({ default: m.CinematicLoad })),
);
...
const CinematicLimits = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicLimits").then((m) => ({ default: m.CinematicLimits })),
);
const CinematicFree = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicFree").then((m) => ({ default: m.CinematicFree })),
);
...
const CinematicKeepalive = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicKeepalive").then((m) => ({ default: m.CinematicKeepalive })),
);
...
const CinematicInotify = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicInotify").then((m) => ({ default: m.CinematicInotify })),
);
...
const CinematicSignals = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicSignals").then((m) => ({ default: m.CinematicSignals })),
);
const CinematicExit = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicExit").then((m) => ({ default: m.CinematicExit })),
);
...
const CinematicMapped = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicMapped").then((m) => ({ default: m.CinematicMapped })),
);
...
const CinematicFds = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicFds").then((m) => ({ default: m.CinematicFds })),
);
const CinematicWriteback = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicWriteback").then((m) => ({ default: m.CinematicWriteback })),
);
const CinematicConntrack = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicConntrack").then((m) => ({ default: m.CinematicConntrack })),
);
...
const CinematicTransfer = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicTransfer").then((m) => ({ default: m.CinematicTransfer })),
);
const CinematicGlossary = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicGlossary").then((m) => ({ default: m.CinematicGlossary })),
);
const CinematicToday = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicToday").then((m) => ({ default: m.CinematicToday })),
);
...
const CinematicAllocate = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicAllocate").then((m) => ({ default: m.CinematicAllocate })),
);

const CinematicChain = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicChain").then((m) => ({ default: m.CinematicChain })),
);
...
const CinematicFirewall = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicFirewall").then((m) => ({ default: m.CinematicFirewall })),
);

const CinematicTriage = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicTriage").then((m) => ({ default: m.CinematicTriage })),
);
...
const CinematicScenario = lazyWithRetry(() =>
  import("@/pages/cinematic/CinematicScenario").then((module) => ({
    default: module.CinematicScenario,
  })),
);
  ...
  return (
    <div key={location} className="route-fade">
        <Switch>
          ...
          <Route path="/writeback">
            <Suspense fallback={<RouteLoading />}>
              <CinematicWriteback />
            </Suspense>
          </Route>
          <Route path="/conntrack">
            <Suspense fallback={<RouteLoading />}>
              <CinematicConntrack />
            </Suspense>
          </Route>
          ...
          <Route path="/allocate">
            <Suspense fallback={<RouteLoading />}>
              <CinematicAllocations />
            </Suspense>
          </Route>
          <Route path="/allocate/:slug">
            <Suspense fallback={<RouteLoading />}>
              <CinematicAllocate />
            </Suspense>
          </Route>
