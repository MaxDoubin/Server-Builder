      ...
      <div className="relative px-6 pb-32 pt-32 md:px-10">
        <div className="mx-auto max-w-[980px]">
          ...
          <div className="mt-11 flex flex-wrap gap-2">
            {SCENARIOS.map((item) => (
              <button
                ...
                className={`rounded-full border px-4 py-2 text-left font-mono-tight text-[0.71875rem] transition-colors ${
          ...
          <section className="mt-6 rounded-2xl border border-[hsl(var(--brand-iron))] bg-[hsl(var(--brand-graphite)/0.5)] p-6">
            ...
            <p className="mt-3 font-mono-tight text-[0.84375rem] leading-relaxed text-[hsl(var(--brand-bone-dim))]" data-testid="brief">
              {scenario.brief}
            </p>

            <ul className="mt-4 flex flex-wrap gap-x-6 gap-y-1 font-mono-tight text-[0.71875rem] text-[hsl(var(--brand-ash))]">
              ...
              {rows.map(({ copy, verdict, index }) => {
                ...
                return (
                  ...
                  >
                    ...
                    {revealed ? (
                      <p className="mt-2 font-mono-tight text-[0.75rem] leading-relaxed text-[hsl(var(--brand-bone-dim))]">
                        {verdict.usable ? (
                          <>
            ...
            {!revealed ? (
              <button
                ...
                data-testid="run"
                className="mt-6 rounded-full border border-[hsl(var(--brand-signal)/0.6)] bg-[hsl(var(--brand-signal)/0.08)] px-5 py-2.5 font-mono-tight text-[0.75rem] uppercase tracking-[0.16em] text-[hsl(var(--brand-bone))] transition-colors hover:bg-[hsl(var(--brand-signal)/0.14)]"
              >
                Run the incident
              </button>
            ) : (
              <div className="mt-6 space-y-4" data-testid="outcome" aria-live="polite">
                <p className="font-mono-tight text-[0.84375rem] leading-relaxed text-[hsl(var(--brand-bone))]">
                  {chosen === null
          ...
          <section className="mt-12">
            ...
            <dl className="mt-4 space-y-4">
              {[
                ...
                <div key={term}>
                  <dt className="font-mono-tight text-[0.8125rem] text-[hsl(var(--brand-bone))]">{term}</dt>
                  <dd className="mt-1 font-mono-tight text-[0.78125rem] leading-relaxed text-[hsl(var(--brand-ash))]">
                    {detail}
                  </dd>
                </div>
              ))}
