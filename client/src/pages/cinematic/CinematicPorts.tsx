    ...
    <CinematicLayout>
      ...
      <div className="relative px-6 pb-32 pt-32 md:px-10">
        <div className="mx-auto max-w-[1040px]">
          ...
          <ul className="mt-11 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3" data-testid="ports-list">
            {CASES.map((item) => (
              <li key={item.slug}>
                <button
                  type="button"
                ...
                <div className="space-y-2.5" data-testid="ports-bars">
                  {rows.map((row) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-baseline justify-between gap-3 font-mono-tight text-[0.71875rem]">
                  ...
                  <p className="pt-1 font-mono-tight text-[0.6875rem] leading-relaxed text-[hsl(var(--brand-ash)/0.85)]">
