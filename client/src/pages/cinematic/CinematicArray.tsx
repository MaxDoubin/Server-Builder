    ...
    <CinematicLayout>
      ...
      <div className="relative px-6 pb-32 pt-32 md:px-10">
        <div className="mx-auto max-w-[940px]">
          ...
          {tooFew ? (
            <p
              className="mt-5 font-mono-tight text-[0.8125rem] text-[hsl(var(--brand-danger))]"
          ...
          <section className="mt-6 rounded-2xl border border-[hsl(var(--brand-iron))] bg-[hsl(var(--brand-graphite)/0.5)] p-5">
            ...
            <p className="mt-3 font-mono-tight text-[0.8125rem] leading-[1.75] text-[hsl(var(--brand-bone-dim))]">
              {result.ureConsequence}
            </p>
            {result.notes.map((note, index) => (
              <p
                key={index}
                className="mt-3 font-mono-tight text-[0.8125rem] leading-[1.75] text-[hsl(var(--brand-ash))]"
              >
                {note}
              </p>
            ))}
                ...
                >
                  <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
                    ...
                    <button
                      ...
                      className="min-h-[36px] font-mono-tight text-[0.6875rem] uppercase tracking-[0.2em] text-[hsl(var(--brand-signal))] underline-offset-4 hover:underline"
                    >
                      Load it
                    </button>
                  </div>
          ...
          <p className="mt-11 font-mono-tight text-[0.75rem] leading-relaxed text-[hsl(var(--brand-ash))]">
...
function NumberField({
  ...
  return (
    <Field label={label}>
      ...
      />
      {note ? (
        <span className="mt-1 block font-mono-tight text-[0.6875rem] leading-snug text-[hsl(var(--brand-ash))]">
          {note}
        </span>
      ) : null}
    </Field>
...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-[hsl(var(--brand-iron))] bg-[hsl(var(--brand-graphite)/0.5)] p-5">
      <h2 className="font-techno text-[0.625rem] uppercase tracking-[0.32em] text-[hsl(var(--brand-ash))]">
        · {label}
      </h2>
      <p
